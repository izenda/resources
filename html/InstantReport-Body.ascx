      ...
      <div class="right-help" id="rightHelpDiv" style="margin-left: 0px; padding-top: 10px; padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
        ...
        <div id="htmlFilters" class="css-only-clearfix" style="border-bottom: 3px dotted #ccc; margin-bottom: 10px;">
          ...
          <div style="display: none;">
            ...
            <div class="addFilterTemplate" title="Add New Filter"></div>
          ...
          <div id="propertiesDiv">
            ...
            <div style="float: left; width: 100%; max-width: 400px; margin-right: 50px;">
              <table cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr class="field-prop-row">
                  <td>
                    <select id="propSTFunctions" style="margin: 0px; width: 100%;" onchange="document.getElementById('propStExpression').style.display=(this.value=='EXPRESSION'?'':'none'); PreviewFieldDelayed(1000);"></select>
                  </td>
                </tr>
                <tr class="field-prop-row">
                  <td>
                    <input id="propStExpression" type="text" value="" style="width: 100%; margin: 0px; margin-top: 4px; display: none;" />
                  </td>
                </tr>
              ...
              <table>
                  ...
                  <td>
                    <div style="width: 100%;">
                      <div class="multi-valued-check-advanced">
                        <label msv="L" msvs="L,M,R" id="labelJ" onclick="javascript:UpdateMSV('labelJ', true);">L</label>
                      </div>
                ...
                <tr>
                  <td>
                    <div style="width: 100%;">
                      <div class="multi-valued-check-advanced">
                        <label msv="&nbsp;" msvs="&nbsp;,L,M,R" id="valueJ" onclick="javascript:UpdateMSV('valueJ', true);">&nbsp;</label>
                      </div>
