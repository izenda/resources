...
<link rel="stylesheet" type="text/css" href="./<%=AdHocSettings.ResourcesProviderUniqueUrlWithDelimiter%>extres=components.vendor.ionrangeslider.ion.rangeSlider.css" />
<link rel="stylesheet" type="text/css" href="./<%=AdHocSettings.ResourcesProviderUniqueUrlWithDelimiter%>extres=components.vendor.ionrangeslider.ion.rangeSlider.skinHTML5.css" />
<!-- old styles -->
...
<link rel="stylesheet" type="text/css" href="./<%=AdHocSettings.ResourcesProviderUniqueUrlWithDelimiter%>extres=components.dashboard.css.dashboard.css" />
...
<script src="./<%=AdHocSettings.ResourcesProviderUniqueUrlWithDelimiter%>extres=components.dashboard.module-loader.js"></script>
