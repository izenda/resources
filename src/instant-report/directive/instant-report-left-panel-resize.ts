...
interface IIzendaInstantReportLeftPanelResizeScope extends ng.IScope {
	...
	opened: any;
	$izendaCompatibility: any;
}

/**
 * Resize left panel directive
 */
izendaInstantReportModule.directive('izendaInstantReportLeftPanelResize', ['$window', '$izendaCompatibility',
	function ($window, $izendaCompatibility) {
		return {
			...
			link: function ($scope: IIzendaInstantReportLeftPanelResizeScope, elem) {
