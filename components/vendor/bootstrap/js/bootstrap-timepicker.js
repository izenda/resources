...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        hourTemplate = '<input type="text" class="bootstrap-timepicker-hour form-control" style="padding: 6px 0; width: 40px;" maxlength="2"/>';
        minuteTemplate = '<input type="text" class="bootstrap-timepicker-minute form-control" style="padding: 6px 0; width: 40px;" maxlength="2"/>';
        secondTemplate = '<input type="text" class="bootstrap-timepicker-second form-control" style="padding: 6px 0; width: 40px;" maxlength="2"/>';
        meridianTemplate = '<input type="text" class="bootstrap-timepicker-meridian form-control" style="padding: 6px 0; width: 40px;" maxlength="2"/>';
      } else {
